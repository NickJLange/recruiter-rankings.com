...
class ReviewSubmissionTest < ActionDispatch::IntegrationTest
  setup do
    ...
    @recruiter = Recruiter.create!(name: "Nina Sharp", company: @company, public_slug: "nina-sharp")
  end

  test "can submit a review" do
    get "/recruiters/nina-sharp"
    assert_response :success

    post "/reviews", params: {
      review: {
        recruiter_slug: "nina-sharp",
        overall_score: 5,
    ...
    assert_redirected_to recruiter_path("nina-sharp")
    follow_redirect!
    assert_response :success
    ...
    review = Review.last
    assert_equal "nina-sharp", review.recruiter.public_slug
